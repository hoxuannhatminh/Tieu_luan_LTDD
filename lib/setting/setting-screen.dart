                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Padding(
                                  ...
                                  child: dynamicText("Nam", fontSize: 16)
                                ),
                              ],
                            ),
                            Padding(
                          ...
                          children: <Widget>[
                            Row(
                              children: <Widget>[
                                ...
                                Padding(
                                  padding: EdgeInsets.all(0),
                                  child: dynamicText("0123456789", fontSize: 16)
                                ),
                              ],
                            ),
                            Padding(
                          ...
                          children: <Widget>[
                            Row(
                              children: <Widget>[
                                ...
                                Padding(
                                  padding: EdgeInsets.all(0),
                                  child: dynamicText("tomcruise@gmail.com", fontSize: 16)
                                ),
                              ],
                            ),
                            Padding(
                          ...
                          children: <Widget>[
                            Row(
                              children: <Widget>[
                                ...
                                Padding(
                                  padding: EdgeInsets.all(0),
                                  child: dynamicText("Đã có gia đình", fontSize: 16)
                                ),
                              ],
                            ),
                            Padding(
                          ...
                          children: <Widget>[
                            Row(
                              children: <Widget>[
                                ...
                                Padding(
                                  padding: EdgeInsets.all(0),
                                  child: dynamicText("Quảng Vinh, Quảng Điền, Thừa Thiên Huế", fontSize: 16)
                                ),
                              ],
                            ),
                            Padding(
                          ...
                          children: <Widget>[
                            Row(
                              children: <Widget>[
                                ...
                                Padding(
                                  padding: EdgeInsets.all(0),
                                  child: dynamicText("35 tuổi", fontSize: 16)
                                ),
                              ],
                            ),
                            Padding(
                      ...
                      Padding(
                        ...
                        child: dynamicText("Setting", fontSize: 20, fontWeight: FontWeight.bold)
                      ),
                          ...
                          children: <Widget>[
                            Row(
                              children: <Widget>[
                                ...
                                Padding(
                                  padding: EdgeInsets.all(0),
                                  child: dynamicText("ĐĂNG XUẤT", fontSize: 16)
                                ),
                              ],
                            ),
                            Padding(
