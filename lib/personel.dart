                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: dynamicText("Check", fontSize: 13, fontWeight: FontWeight.bold)
                          )
                        ]
                      ),
                    ),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            padding: const EdgeInsets.only(right: 8.0),
                            child: dynamicText("Làm việc", fontSize: 14, fontWeight: FontWeight.bold)
                          )
                        ]
                      ),
                    ),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            padding: const EdgeInsets.only(right: 8.0),
                            child: dynamicText("Cá nhân", fontSize: 14, fontWeight: FontWeight.bold)
                          )
                        ]
                      ),
                    ),
